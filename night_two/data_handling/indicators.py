...
INDICATORS = {
    'sma': {'func': night_two.data_handling.indicators.calculate_sma, 'params': ['period']},
    'rsi': {'func': night_two.data_handling.indicators.calculate_rsi, 'params': ['period']},
    'bbands': {'func': night_two.data_handling.indicators.calculate_bbands, 'params': ['period']},
    'macd': {'func': night_two.data_handling.indicators.calculate_macd, 'params': ['fastperiod', 'slowperiod', 'signalperiod']},
    'psar': {'func': night_two.data_handling.indicators.calculate_psar, 'params': ['acceleration', 'maximum']},
    'trange': {'func': night_two.data_handling.indicators.calculate_trange, 'params': []},
    'wma': {'func': night_two.data_handling.indicators.calculate_wma, 'params': ['period']},
    'ema': {'func': night_two.data_handling.indicators.calculate_ema, 'params': ['period']},
    'aroon': {'func': night_two.data_handling.indicators.calculate_aroon, 'params': ['period']},
    'atr': {'func': night_two.data_handling.indicators.calculate_atr, 'params': ['period']},
    'ad': {'func': night_two.data_handling.indicators.calculate_ad, 'params': []},
    'adx': {'func': night_two.data_handling.indicators.calculate_adx, 'params': ['period']},
    'ichimoku': {'func': night_two.data_handling.indicators.calculate_ichimoku, 'params': []},
    'atr_trailing_stops': {'func': night_two.data_handling.indicators.calculate_atr_trailing_stops, 'params': ['high', 'low', 'close']},
    'linear_regression': {'func': night_two.data_handling.indicators.calculate_linear_regression, 'params': []},
    'cmo': {'func': night_two.data_handling.indicators.calculate_cmo, 'params': ['period']},
    'dpo': {'func': night_two.data_handling.indicators.calculate_dpo, 'params': ['period']},
    'vol_oscillator': {'func': night_two.data_handling.indicators.calculate_vol_oscillator, 'params': ['short_period', 'long_period']},
    'williams_ad': {'func': night_two.data_handling.indicators.calculate_williams_ad, 'params': []},
    'cci': {'func': night_two.data_handling.indicators.calculate_cci, 'params': ['timeperiod']},
    'pvt': {'func': night_two.data_handling.indicators.calculate_pvt, 'params': []},
    'tmf': {'func': night_two.data_handling.indicators.calculate_tmf, 'params': ['timeperiod']},
    'donchian_channels': {'func': night_two.data_handling.indicators.calculate_donchian_channels, 'params': ['n']},
    'keltner_channels': {'func': night_two.data_handling.indicators.calculate_keltner_channels, 'params': ['n']},
    'atr_bands': {'func': night_two.data_handling.indicators.calculate_atr_bands, 'params': ['n']},
    'elder_ray_index': {'func': night_two.data_handling.indicators.calculate_elder_ray_index, 'params': ['n']},
    'hull_moving_average': {'func': night_two.data_handling.indicators.calculate_hull_moving_average, 'params': ['n']},
    'rainbow_moving_averages': {'func': night_two.data_handling.indicators.calculate_rainbow_moving_averages, 'params': ['periods']},
    'chaikin_money_flow': {'func': night_two.data_handling.indicators.calculate_chaikin_money_flow, 'params': ['n']},
    'chaikin_oscillator': {'func': night_two.data_handling.indicators.calculate_chaikin_oscillator, 'params': []},
    'chaikin_volatility': {'func': night_two.data_handling.indicators.calculate_chaikin_volatility, 'params': ['n']},
     'standard_deviation_channels': {'func': night_two.data_handling.indicators.calculate_standard_deviation_channels, 'params': ['n']},
    'wilder_moving_average': {'func': night_two.data_handling.indicators.calculate_wilder_moving_average, 'params': ['n']},
    'twiggs_momentum_oscillator': {'func': night_two.data_handling.indicators.calculate_twiggs_momentum_oscillator, 'params': ['n']},
    'twiggs_trend_index': {'func': night_two.data_handling.indicators.calculate_twiggs_trend_index, 'params': ['n']},
    'atr_trailing_stops': {'func': night_two.data_handling.indicators.calculate_atr_trailing_stops, 'params': ['high', 'low', 'close', 'atr_period', 'multiplier']},
    'linear_regression': {'func': night_two.data_handling.indicators.calculate_linear_regression, 'params': ['window']},
    'coppock': {'func': night_two.data_handling.indicators.calculate_coppock, 'params': ['short_roc_period', 'long_roc_period', 'wma_period']},
    'kst': {'func': night_two.data_handling.indicators.calculate_kst, 'params': ['rc1', 'rc2', 'rc3', 'rc4', 'sma1', 'sma2', 'sma3', 'sma4']},
    'force_index': {'func': night_two.data_handling.indicators.calculate_force_index, 'params': ['period']}
}
